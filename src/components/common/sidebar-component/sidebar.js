...
// import logo from '../../../assets/images/expertronsLogo.jpg';
...
const Sidebar = (props) => {
    ...
    const goToInteraction = (data) => {
        props.history.push({
            pathname: `/editInteraction/${data._id}`,
            state: data
        })
    }
            ...
            <div className="page-sidebar">
                 {/*<div className="main-header-left d-none d-lg-block">
                    <div className="logo-wrapper compactLogo">
                        ...
                        <img className="blur-up lazyloaded" style={{width: 90}} src={logo} alt="Expertrons Logo" />
